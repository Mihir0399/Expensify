...
const AddTransaction = ({navigation}) => {
    ...
    if (
      ...
      if (amount != 0) {
        ...
        firestore()
          ...
          .set({
            value:
              userIncomeAndExpences != undefined
                ? [...userIncomeAndExpences, data]
                : [data],
          })
          .then(result => {
            setAmount(null);
            setCameraPhoto(undefined);
            setCurrentCategory('');
            setCurrentMode('');
            setCurrentType('');
            setName('');
        ...
        setErrTxt('Amount Should not Be Zero');
      }
    } else {
  ...
  return (
    <View
      ...
      <Text style={styles.txtAllT}>Add transaction</Text>
      ...
      <Text style={styles.txtAllT}>Transaction Image</Text>
      <TextInput
      ...
      <TouchableOpacity
        ...
        <View
          ...
          <Text style={styles.txtLogin}>Save</Text>
        </View>
      </TouchableOpacity>
